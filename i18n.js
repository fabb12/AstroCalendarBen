...
(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    'Scegli una cartella esistente': 'Choose an existing folder', 'Crea “astrocalben”': 'Create “astrocalben”',
  ...
  const fragments = [
    ...
    ['Scegli la cartella che contiene i video da mostrare.', 'Choose the folder containing the videos to display.'],
    ['La cartella di AstroCalendario non è ancora collegata', 'The AstroCalendar folder is not connected yet'],
    ['Puoi scegliere una cartella già esistente e caricare subito i video che contiene, oppure crearne una nuova.', 'Choose an existing folder and immediately load its videos, or create a new one.'],
