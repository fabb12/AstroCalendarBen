...
(async () => {
  ...
  await pagina.route('**/api.planespotters.net/pub/photos/hex/wiki190', r => r.fulfill({
    contentType: 'application/json', body: JSON.stringify({ photos: [{
      thumbnail: { src: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==' },
      photographer: 'Prova'
    }] })
  }));
