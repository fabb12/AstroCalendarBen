...
| La rotella sul laboratorio si mangia lo scorrimento della pagina | non lo fa, ed è voluto (`didLenteAttacca`): finché la lente è ferma la rotella zooma **solo** con Ctrl/⌘ premuto, e il dito scorre la pagina (`touch-action: pan-y`). Appena la lente è accesa la rotella è sua e `touch-action` passa a `none`; tornando a 1× — col ⟲, col doppio clic o continuando a rimpicciolire — restituisce tutto alla pagina |
