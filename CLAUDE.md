...
| La rotella sul laboratorio si mangia lo scorrimento della pagina | non lo fa, ed è voluto (`didLenteAttacca`): finché la vista è ferma la rotella zooma **solo** con Ctrl/⌘ premuto, e il dito scorre la pagina (`touch-action: pan-y`). Appena la vista è ingrandita **o girata** la rotella è sua e `touch-action` passa a `none`; tornando a com'era — col ⟲, col doppio clic o continuando a rimpicciolire — restituisce tutto alla pagina |
| Chi fa cosa col dito, sulle tele del laboratorio | le stesse regole della vista 3D, alla lettera, perché è lo stesso gesto: **un dito gira** la scena (il dito porta con sé la scena, non l'occhio), **due dita** avvicinano *e* spostano, col mouse si sposta con Maiusc o col tasto destro. Dove la scena non si può girare un dito solo torna a spostare il disegno ingrandito. La tela della fionda ha `trascina: false` — lì il dito ha già un mestiere, sposta il punto di passaggio — e si gira col tasto dei gradi; il suo trascinamento legge il punto con `didLenteMondo()`, che adesso disfa **anche** il giro (e si arrende sotto i 0,05 di determinante: quasi di taglio, tornare indietro vorrebbe dire moltiplicare per venti) |
